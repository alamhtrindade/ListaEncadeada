...
void imprimirCompra(compra *comp){
    ...
    int menuPrincipal(){
        ...
        printf("***************************************************************************\n");
        printf("*                 SISTEMA BASICO DE GESTAO PARA MERCADOS                  *\n");
        printf("***************************************************************************\n");
        printf("*     1 - PRODUTOS   |   2 - CLIENTES   |   3 - COMPRAS   |   4 - SAIR    *\n");
        printf("***************************************************************************\n");
        printf("\n");
        printf("OPCAO:  ");
        scanf("%d",&opcao);
...
int menuProdutos(){
    ...
    printf("*                                PRODUTOS                                 *\n");
    printf("***************************************************************************\n");
    printf("* 1 - PESQ. DESCRICAO | 2 - PESQ. FORNECEDOR | 3 - CADASTRAR | 0 - VOLTAR *\n");
    printf("***************************************************************************\n");
    printf("\n");
    printf("OPCAO:  ");
    scanf("%d",&opcao);
...
int menuSubMenuProdutos(int opcao){
    switch(opcao){
        case 1:{
        ...
        case 2:{
            ...
            printf("***************************************************************************\n");
            printf("*                       PESQUISAR POR FORNECEDOR                          *\n");
            printf("***************************************************************************\n");
            printf("\n");
            return opcao;
        }
...
int menuClientes(){
    ...
    printf("*                                CLIENTES                                 *\n");
    printf("***************************************************************************\n");
    printf("*   1 - PESQUISAR POR NOME   |   2 - CADASTRAR CLIENTE   |   0 - VOLTAR   *\n");
    printf("***************************************************************************\n");
    printf("\n");
    printf("OPCAO:  ");
    scanf("%d",&opcao);
...
int menuCompras(){
    ...
    printf("*                                COMPRAS                                  *\n");
    printf("***************************************************************************\n");
    printf("*   1 - PESQ. COMPRAS POR CPF   |   2 - PESQ. COMPRAS POR COD. PRODUTO    *\n");
    printf("*   3 - REALIZAR COMPRA         |   0 - VOLTAR                            *\n");
    printf("***************************************************************************\n");
    printf("\n");
    printf("OPCAO:  ");
    scanf("%d",&opcao);
...
int menuSubMenuCompras(int opcao){
    switch(opcao){
        case 1:{

            printf("***************************************************************************\n");
            printf("*                       PESQUISAR COMPRAS POR CPF                         *\n");
            printf("***************************************************************************\n");
            printf("\n");
            return opcao;
        }
        ...
        case 2:{
            ...
            printf("***************************************************************************\n");
            printf("*                PESQUISAR COMPRAS POR CODIGO DO PRODUTO                  *\n");
            printf("***************************************************************************\n");
            printf("\n");
            return opcao;
        }
